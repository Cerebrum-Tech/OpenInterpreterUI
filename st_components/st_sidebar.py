...
def about_us():
    ...
    html_chat = '<center><h5>The Cere Analytics runs code on a sandbox environment connected to the Internet. Make sure to use it responsibly on production envidonments.</h5>'
...
#                 "Upload your JSON file credentials", type=["json"])
#             if uploaded_file:
